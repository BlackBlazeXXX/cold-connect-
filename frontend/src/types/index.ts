...
export type RepliedAfterStage = 'initial' | 'follow_up_1' | 'follow_up_2' | 'late';
...
export interface Contact {
  ...
  replied_after: RepliedAfterStage | null; // auto-detected: which stage contact was in when reply came
